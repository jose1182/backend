...
describe('Conversacion Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'conversacion', component: ConversacionComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.conversacions?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
