...
export class ConversacionComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.conversacionService
      ...
      .subscribe({
        next: (res: HttpResponse<IConversacion[]>) => {
  ...
  protected onSuccess(data: IConversacion[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
