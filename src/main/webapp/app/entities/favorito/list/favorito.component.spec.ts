...
describe('Favorito Management Component', () => {
  let comp: FavoritoComponent;
  let fixture: ComponentFixture<FavoritoComponent>;
  let service: FavoritoService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'favorito', component: FavoritoComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(FavoritoComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.favoritos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
